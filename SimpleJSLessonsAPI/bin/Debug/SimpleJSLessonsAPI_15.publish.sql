...
GO
PRINT N'Altering [dbo].[UserSavedDemos]...';


GO
ALTER TABLE [dbo].[UserSavedDemos] ALTER COLUMN [demoHash] VARCHAR (24) NOT NULL;

ALTER TABLE [dbo].[UserSavedDemos] ALTER COLUMN [demoTitle] VARCHAR (128) NULL;
...
ALTER TABLE [dbo].[userSavedLessons] ALTER COLUMN [lessonTitle] VARCHAR (128) NULL;
